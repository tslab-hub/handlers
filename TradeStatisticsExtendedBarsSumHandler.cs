...
namespace TSLab.Script.Handlers
{
    ...
    [HelperName("Trade Statistics Extended Strings Sum 1", Language = Constants.En)]
    [HelperName("Расширенная сумма строк торговой статистики 1", Language = Constants.Ru)]
    [InputsCount(1)]
    [Input(0, TemplateTypes.TRADE_STATISTICS | TemplateTypes.LAST_CONTRACTS_TRADE_STATISTICS)]
    [OutputsCount(1)]
    [OutputType(TemplateTypes.DOUBLE)]
    [Description("Блок 'Расширенная сумма строк торговой статистики 1' выдает значение, основанное на сумме значений строк торговой статистики.")]
    [HelperDescription("", Constants.En)]
    public sealed class TradeStatisticsExtendedBarsSumHandler : TradeStatisticsExtendedBarsHandler, ITradeStatisticsExtendedBarsSumHandler
    {
        /// <summary>
